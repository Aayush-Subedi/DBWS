        ...
        <div class="filters col-3">
            <form>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="rating_item_min" id="rating_item_min" min="0" max="5">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="rating_item_max" class="col-sm-2 col-form-label">To</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="rating_item_max" id="rating_item_max" min="0" max="5">
                    </div>
                </div>
            </form>
        </div>
