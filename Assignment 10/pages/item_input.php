...
<form action="../scripts/inserter.php" method="post" class="form">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name="category" placeholder="category" maxlength="30">
        </div>
    </div>
    <div class="form-group row">
        <label for="condition" class="col-sm-2 col-form-label">Condition</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" name="condition" placeholder="condition" maxlength="50">
        </div>
    </div>
    <div class="form-group row">
        <label for="rating" class="col-sm-2 col-form-label">Average Rating</label>
        <div class="col-sm-10">
            <input type="number" class="form-control" name="rating" placeholder="rating" min="0" max="5" value="0">
        </div>
    </div>
    <div class="form-group row">
        <label for="price" class="col-sm-2 col-form-label">Price</label>
        <div class="col-sm-10">
            <input type="number" class="form-control" name="price" placeholder="price" required min="0" value="0">
        </div>
    </div>
    <div class="form-group row">
        <label for="times_rented" class="col-sm-2 col-form-label">Times Rented</label>
        <div class="col-sm-10">
            <input type="number" class="form-control" name="times_rented" placeholder="times_rented" min="0" value="0">
        </div>
    </div>
    <div class="form-group row">
        <label for="renter_id" class="col-sm-2 col-form-label">Renter Id</label>
        <div class="col-sm-10">
            <input type="number" class="form-control" name="renter_id" placeholder="000" required min="0">
...
<script type="text/javascript">
    function table(data) {
        ...
        var list = data.split("{");
        var users = [];
        var html = "<table class='table table-striped' id='table'><tr><th>renter_id</th><th>phone_no</th><th>address</th><th>date of birth</th><th>average_rating</th></tr><tr>"
