...
<form action="../scripts/inserter.php" method="post" class="form">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name="address" placeholder="Campus Ring 1">
        </div>
    </div>
    <div class="form-group row">
...
<script type="text/javascript">
    function table(data) {
        ...
        var list = data.split("{");
        var users = [];
        var html = "<table class='table table-striped' id='table'><tr><th>user_id</th><th>fname</th><th>lname</th><th>email</th></tr><tr>"
