...
<script type="text/javascript">
    ...
    function table(data) {
        ...
        var list = data.split("{");
        var users = [];
        var html = "<table class='table' id='table'><tr><th>User Id</th><th>First Name</th><th>Rent Id</th><th>Duration Start</th><th>Duration End</th></tr><tr id='row' onclick='check(event)'>"
